	...
	server = new McpServer(
		...
		},
		{
			capabilities: {
				...
				resources: {},
				completions: {},
				// Enable logging capability so we can send notifications to the client
				// This allows the server to inform the client about events that happened
				// as side effects of operations, like successful sampling requests
				logging: {},
				prompts: {},
			},
			instructions: `
